...
knitr::include_graphics("acp_2.png")
```

A la lecture du graphique de corrélation des variables, nous remarquons comme attendu que le pourcentage de réussite est corrélé avec le nombre d'images test et le nombre d'images d'entrainements. 
